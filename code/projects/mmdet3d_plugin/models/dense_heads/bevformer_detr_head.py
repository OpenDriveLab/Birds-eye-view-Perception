...
# source licenses:
# bevformer_detr_head.py       OpenPerceptionX        Apache License, Version 2.0
#
...
class BEV_FormerHead(DETRHead):
    ...
    def __init__(self,
        ...
        super(BEV_FormerHead, self).__init__(*args, transformer=transformer, **kwargs)
