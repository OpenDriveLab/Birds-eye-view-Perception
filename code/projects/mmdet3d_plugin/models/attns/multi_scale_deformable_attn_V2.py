...
# source licenses:
# multi_scale_deformable_attn_V2.py       OpenPerceptionX        Apache License, Version 2.0
#
...
class CustomMultiScaleDeformableAttentionV2(BaseModule):
    ...
    def __init__(self,
        ...
        self.sampling_offsets = nn.Linear(embed_dims, num_bev_queue * num_heads * num_levels * num_points * 2)
    ...
    # @run_time('CustomMultiScaleDeformableAttention')
