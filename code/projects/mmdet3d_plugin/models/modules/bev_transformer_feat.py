...
class BEVTransformerV2(BaseModule):
    ...
    def __init__(
            ...
            **kwargs):
        super(BEVTransformerV2, self).__init__(**kwargs)
    ...
    def forward(
        ...
        if self.use_shift == 'waymo_shift':
            ...
            shift_y = 0
            shift_x = 0
        # print(2, shift_x, shift_y, bev_embed.shape)
        ...
        #prev_bev = prev_bev.reshape(bev_h, bev_w, -1).permute(2, 0, 1)
        #prev_bev = rotate(prev_bev, rotation_angle)
        #save_tensor(prev_bev, '{i}_prev_rot.png'.format(i=self.count))
        #
