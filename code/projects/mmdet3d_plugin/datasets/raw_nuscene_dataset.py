...
class RawNuScenesDataset(CustomNuScenesDataset):
    r"""NuScenes Dataset.
    ...
    def get_data_info(self, index):
        ...
        lidar = self.nusc.get('sample_data', info['LIDAR_TOP'])
    ...
    def _format_bbox(self, results, jsonfile_prefix=None):
        ...
        for sample_id, det in enumerate(mmcv.track_iter_progress(results)):
            ...
            sample_token = self.data_infos[sample_id]['cams']['CAM_FRONT']['sample_data_token']
