...
def main():
    ...
    # 650649600*6  3.8 GFLops For self attention of decoder for 900 queries

    flops = str(float(flops.split(' ')[0]) + 1.9) + ' GFLOPs'
    split_line = '=' * 30
