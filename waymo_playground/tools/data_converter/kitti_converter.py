...
def create_waymo_info_file(data_path,
    ...
    # testing_camera = _read_imageset_file(str(imageset_folder / 'testing_camera.txt'))
    ...
    # waymo_infos_testing_camera = get_waymo_image_info(
    #     data_path,
    #     training=False,
    #     velodyne=False,
    #     label_info=False,
    #     calib=True,
    #     pose=True,
    #     image_ids=testing_camera,
    #     relative_path=relative_path,
    #     max_sweeps=max_sweeps)
    # filename = save_path / f'{pkl_prefix}_infos_test_camera.pkl'
    # print(f'Waymo info train file is saved to {filename}')
    # mmcv.dump(waymo_infos_testing_camera, filename)
