...
def custom_build_dataset(cfg, default_args=None):
    ...
    from projects.mmdet3d_plugin.datasets import CustomCBGSDataset
    ...
    elif cfg['type'] == 'CustomCBGSDataset':
        dataset = CustomCBGSDataset(custom_build_dataset(cfg['dataset'], default_args))
