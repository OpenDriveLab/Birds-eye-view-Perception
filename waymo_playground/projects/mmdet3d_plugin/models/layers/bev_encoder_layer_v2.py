...
from .base_transformer_layer import CustomBaseTransformerLayer


@TRANSFORMER_LAYER.register_module()
class BEVEncoderLayerV2(CustomBaseTransformerLayer):
    ...
    def __init__(self,
        ...
        super(BEVEncoderLayerV2, self).__init__(attn_cfgs=attn_cfgs,
