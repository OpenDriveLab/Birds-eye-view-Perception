...
class DefaultFormatBundle(object):
    ...
    def __call__(self, results):
        ...
        for key in [
                ...
                'pts_semantic_mask', 'centers2d', 'depths', 'gt_labels_3d_adj',
        ]:
        ...
        if 'gt_bboxes_3d_adj' in results:
            if isinstance(results['gt_bboxes_3d_adj'], BaseInstance3DBoxes):
                results['gt_bboxes_3d_adj'] = DC(
                    results['gt_bboxes_3d_adj'], cpu_only=True)
            else:
                results['gt_bboxes_3d_adj'] = DC(
                    to_tensor(results['gt_bboxes_3d_adj']))
    ...
    def __init__(
        ...
        meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img',
                   ...
                   'sequence_group_idx', 'curr_to_prev_lidar_rt', 'curr_to_prev_ego_rt',
                    ...
                    'prev_lidar_to_global_rt', 'sample_index', 'scene_name',
                   'affine_aug')):
        self.keys = keys
