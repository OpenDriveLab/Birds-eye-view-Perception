...
class MaskedBCELoss(nn.Module):
    ...
    def forward(self,
        ...
        return self.get_depth_loss(preds_S, preds_T, mask=mask)
    
    
    def get_depth_loss(self, depth_preds, depth_labels, mask = None):
        # import pdb
        # pdb.set_trace()
        ...
        with autocast(enabled=False):
            ...
            #depth_loss = depth_loss.sum() / max(1.0, depth_labels.shape[0])
