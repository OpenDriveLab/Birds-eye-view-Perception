...
import time
from mmdet3d.core.evaluation import CustomDistEvalHook, CustomDistEvalHook_forDistill
...
def train_detector(model,
    ...
    if validate:
        ...
        elif cfg.get('use_custom_eval_hook_for_distill', False):
            eval_hook = CustomDistEvalHook_forDistill if distributed else eval_hook
        runner.register_hook(
            eval_hook(val_dataloader, **eval_cfg), priority='LOW')
